...
function CourseCard({course} : {course:ICourse}) {
  return (
    <div className="max-w-2xl mb-3 bg-gray-900 shadow-lg rounded-2xl">
      <div className="px-5 py-5">
        <div className="flex items-start">
          ...
          {/* <div className="flex flex-col mt-auto gap-[10px]">
            <button className=" cursor-pointer flex gap-2 items-center text-left text-sm font-medium text-indigo-100 hover:text-white group focus:outline-none focus-visible:border-b focus-visible:border-indigo-100">
              <svg
                width="24px"
                height="24px"
            ...
            <a
              ...
              href="/edit/ug7053w5x6ug5jrkt295g4fo"
            >
              <svg
                width="24px"
                height="24px"
            ...
            <button className=" cursor-pointer flex flex-col items-center text-left text-sm font-medium text-indigo-100 hover:text-white group focus:outline-none focus-visible:border-b focus-visible:border-indigo-100">
              <svg
                width="24px"
                height="24px"
                viewBox="0 0 24 24"
